...
export const ui = {
  ...
  sr: {
    ...
    'services.header.title': 'Наше Услуге',
    'services.header.description':
    ...
    'service.gel-on-natural-nails': 'Гел на ноге',
    'service.mini-fill-up': 'Мини допуна',
    'service.nail-art-entire-nail': 'Дизајн цијелих ногу',
    ...
    'service.leg-depilation-i': 'Депилација леда I',
    'service.leg-depilation-ii': 'Депилација леда II',
    'service.leg-depilation-iii': 'Депилација леда III',
    'service.scar-correction': 'Корекција ожига',
    'service.eyebrow-correction': 'Фарбање ожива',
    'service.eyebrow-tint': 'Фарбање трепавица',
    'service.pedicure': 'Педикир',
    'service.pedicure-gel': 'Педикир + Гел',
    'service.classic-face-treatment': 'Класични третман лица',
    'service.eyelash-tint': 'Освјежење лица',
    'service.face-massage': 'Масажа лица',
    'service.ampule': 'Ампула',
    'service.threading': 'Шминкање',
    'service.permanent-makeup': 'Трајни лак',
  ...
  de: {
    ...
    'services.header.title': 'Unsere Dienstleistungen',
    'services.header.description':
  ...
  'sr-latn': {
    ...
    'services.header.title': 'Naše Usluge',
    'services.header.description':
